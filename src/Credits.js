...
class Credits extends Component {
  render() {
    return (
      <div> <br />
        Guide and recovery information available on the <a className={this.props.classes.credits} href="https://developer.bitcoin.com/insights/scale.cash.html">Bitcoin.com Developer Insights page</a>
        <br /> <br />
